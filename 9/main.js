...
function create_invoice_button(id) {
    const STORE = database.transaction(OBJECTSTORE_NAME, 'readonly').objectStore(OBJECTSTORE_NAME);
        ...
        store.openCursor().onsuccess = (e) => {
            ...
            if (c) {
                if (comparison(c.value)) {
                    ...
                    td.appendChild(create_invoice_button(c.key));
